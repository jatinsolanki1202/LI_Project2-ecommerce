...
import { createUser, handleLogin, homePage, logoutUser, addToCart, listCart, handleCheckOut, getAddresses, handleCodOrderPlacing, handleAddAddress, getAllOrders, getUserProfile } from '../controllers/user.controller.js'
...
router.get('/profile', loginAuth, getUserProfile)
